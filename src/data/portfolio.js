export const portfolioData = {
  ...
  about: {
    introduction: "끊임없이 도전하고 성장하는 프론트엔드 개발자입니다. React, Next.js, Flutter 등 다양한 프레임워크를 활용해 사용자 중심의 웹·앱 서비스를 구현합니다. 비전공자에서 시작해 현재 풀스택 개발자로 재직하며, 미국 교환학생과 글로벌 비즈니스 경험을 바탕으로 국제적 감각과 창의적 사고로 문제를 해결합니다. LittleBank, TripplAI, DevHub 등 실제 서비스 개발과 PM 경험을 통해 기술과 비즈니스를 연결하는 개발자로 성장했습니다.",
    
    motivation: "스마트스토어를 6년간 운영하며 온라인 비즈니스의 한계를 직접 체감했습니다. 단순히 상품을 등록하고 판매하는 것에서 벗어나, 고객 데이터 분석과 맞춤형 마케팅의 필요성을 절실히 느꼈습니다. 하지만 기술적 지식 없이는 아이디어만 있을 뿐 실행에 한계가 있었습니다.\n\nCJ 미국 출장 업무를 하며 현지 스타트업들의 기술 혁신을 목격했습니다. 같은 아이디어라도 기술력의 차이로 완전히 다른 결과를 만들어내는 것을 보며 충격을 받았습니다. 특히 간단한 웹 애플리케이션 하나로 업무 효율을 10배 이상 향상시키는 것을 직접 경험하며, '기술이 곧 경쟁력'이라는 것을 깨달았습니다.\n\n영어학과 출신으로서 안정적인 길을 포기하고 개발자로 전향하는 것은 쉽지 않은 결정이었습니다. 하지만 더 이상 기술에 의존하지 않고 직접 문제를 해결하고 싶었습니다. 국비교육을 통해 기초를 다진 후, 실제 프로젝트들을 진행하며 '코드로 아이디어를 현실화하는 즐거움'을 느꼈고, 이것이 제가 평생 하고 싶은 일임을 확신했습니다.",
    
    growth: "이러한 경험들을 바탕으로 개발자로의 진로 변경을 결심했습니다. 비전공자로서 개발 기초를 탄탄히 다지기 위해 국비지원 교육을 수료하며 체계적인 학습을 진행했습니다. 교육 과정에서 다양한 프로젝트에 참여하며 실전 감각을 익혔고, 웹 개발의 전반적인 과정을 이해하는 풀스택 개발자로 성장하여 현재 관련 분야에 재직 중입니다. 비록 시작은 비전공자였지만, 경영학적 사고와 실무 경험을 통해 사용자의 니즈를 깊이 이해하고 비즈니스 관점에서 문제를 해결하는 데 강점이 있다고 생각합니다. 앞으로도 끊임없이 학습하고 도전하며, 다양한 시각에서 창의적인 해결책을 제시하는 개발자로 성장해 나가겠습니다.",
